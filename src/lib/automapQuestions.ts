...
export const LAB_QUESTIONS: LabQuestion[] = [
  ...
  { id: 'harHaKesefProducts', type: 'rows',
    ...
    hint:     'שורה לכל מוצר. אין צורך להעלות דוח. אם אותה חברה מנהלת לך יותר ממוצר אחד, כתוב בעמודת הניהול איך הבנק מבדיל ביניהם, למשל "אלטשולר שחם גמל" מול "אלטשולר שחם".',
    addLabel: 'הוסף מוצר',
    columns: [
