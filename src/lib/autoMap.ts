...
## תשובות הלקוח מהשאלון — מקור מוסמך
אם מופיע בלוק "תשובות הלקוח מהשאלון", **הלקוח ענה על זה בעצמו, וזה גובר על כל הסקה שלך מהנתונים.** בסתירה בין התשובה לבין מה שהסקת מהקבצים — התשובה מנצחת, ותציין זאת ב‑source של השורה כ"שאלון".
