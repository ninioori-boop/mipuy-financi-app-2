...
- **בלוק ההכנסות** — הפקדות שזוהו בעו"ש, כבר כממוצע חודשי. זה המקור העיקרי לסעיף income. אם הוא קיים, אל תנחש הכנסות ממקום אחר.
  🔴 **תלוש שכר וההפקדה שלו בעו"ש הם אותו כסף. שורה אחת, לא שתיים.** אם צורף תלוש וגם מופיעה הפקדה מאותו מעסיק, אל תיצור "משכורת (מהתלוש)" ליד "משכורת (מהבנק)". התלוש אומר לך **מה** נכנס (ברוטו מול נטו, הפרשות, שווי מעביד), וההפקדה אומרת **כמה** באמת הגיע לחשבון. הסכום בשורה הוא ההפקדה, והתלוש רק מאשר אותה ומסביר אותה. אותו כלל לכל מסמך שמתאר הכנסה שכבר נראית בעו"ש.
...
- **בלוק "גיליון מצורף"** — טבלה גולמית מקובץ אקסל שאינו דוח עו"ש ואינו דוח אשראי: דוח הר הביטוח, דוח פנסיה, תיק ניירות ערך, לוח סילוקין. **קרא אותה כטבלה.** הכותרת האמיתית לא תמיד בשורה הראשונה — יש בקבצים האלה שורות כותרת עליונות, שורות ריקות ולפעמים שתי טבלאות בזה אחר זה. זהה את שורת הכותרת לפי התוכן, והתעלם משורות שאינן נתונים. הסכומים בגיליון הם **כפי שהם**, לא חולקו במספר החודשים.
  דוגמה למה שצפוי משם: דוח הר הביטוח מגיע כשורה לכל כיסוי עם "פרמיה בש"ח" ו"סוג פרמיה" — סכם את הפרמיות **החודשיות** לפי חברה ומוצר, והחזר שורה אחת לכל פוליסה ב‑ins. אל תיצור שורה לכל כיסוי משני.
