...
// Advisor view of all clients' uploaded documents + answers. Rendered inside the
// "העלאת מסמכים" tab for advisors (clients see the questionnaire instead).
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="rounded-xl border border-gold/40 bg-gold/5 p-6 flex items-start justify-between gap-3 flex-wrap">
        <div>
          <h1 className="text-2xl font-bold text-gold mb-1">📥 מסמכי לקוחות</h1>
          <p className="text-muted-txt text-sm">מסמכים ותשובות שלקוחות העלו. צפה/הורד כל קובץ, או פתח ישירות במעבדת ה‑AI.</p>
        </div>
