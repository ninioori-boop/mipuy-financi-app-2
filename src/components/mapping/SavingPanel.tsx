    ...
    <div className="rounded-xl border border-line bg-surface2 p-5 space-y-3">
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-muted-txt">
          סך נכסים: <span className="font-bold text-green-400">{fmt(totalAccum)}</span>
          <span className="mx-2">|</span>
          הפרשה חודשית: <span className="font-bold text-gold">{fmt(totalMonthly)}</span>
        </span>
      </div>
      ...
      <div className="flex items-center justify-between pt-1 border-t border-line">
        ...
        <span className="text-xs text-muted-txt">
          סה&quot;כ נכסים: <span className="font-medium text-green-400">{fmt(totalAccum)}</span>
          <span className="mx-2">|</span>
          הפרשה חודשית: <span className="font-medium text-gold">{fmt(totalMonthly)}</span>
        </span>
      </div>
    </div>
  )
