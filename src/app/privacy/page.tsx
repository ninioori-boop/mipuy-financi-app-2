  ...
  return (
    <div className="min-h-screen bg-surface py-12 px-4">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <Section title="9. אפליקציות מעקב ההוצאות האוטומטי (אנדרואיד ואייפון)">
          <p>
            לצד אפליקציית הווב קיימות אפליקציות נלוות שרושמות תשלומים אוטומטית בחשבונך.
            המידע שהן שולחות זהה בשתיהן: <strong>שם בית העסק והסכום בלבד</strong>. הדרך שבה
            הוא מגיע אליהן שונה בין המערכות, ולכן היא מפורטת בנפרד.
          </p>

          <p className="text-txt"><strong>אנדרואיד (&quot;מעקב הוצאות&quot;)</strong></p>
          <ul>
            <li><strong>איך:</strong> האפליקציה קוראת את <strong>התראות התשלום של Google Wallet</strong> במכשיר, אך ורק כדי לרשום הוצאות בחשבון שלך. תוכן התראות אחר אינו נקרא ואינו נשמר.</li>
            <li><strong>הרשאה:</strong> הגישה להתראות ניתנת על ידך במפורש (אחרי מסך גילוי), וניתנת לביטול בכל רגע בהגדרות המכשיר.</li>
          </ul>

          <p className="text-txt"><strong>אייפון (&quot;הכלכלן של הבית&quot;)</strong></p>
          <ul>
            <li><strong>איך:</strong> האפליקציה <strong>אינה קוראת התראות ואין לה גישה ל-Wallet או לפרטי הכרטיס</strong>. במקום זאת אתה יוצר בעצמך אוטומציה באפליקציית „קיצורי דרך” של אפל, שמעבירה לאפליקציה את פרטי החיוב ברגע התשלום. בלי האוטומציה הזאת האפליקציה לא מקבלת דבר.</li>
            <li><strong>מה מועבר:</strong> תיאור החיוב שאפל מספקת לאוטומציה, שממנו נגזרים שם בית העסק והסכום. מספר הכרטיס אינו נחשף לאוטומציה ואינו מגיע אלינו.</li>
            <li><strong>התראות:</strong> ההתראה שאתה מקבל אחרי חיוב נוצרת <strong>במכשיר עצמו</strong>. אין שירות דחיפה חיצוני ואין מזהה התראות שנשמר אצל אפל או אצלנו.</li>
            <li><strong>ביטול:</strong> מחיקת האוטומציה ב„קיצורי דרך” עוצרת את הרישום האוטומטי מיידית, בלי לגעת בשאר האפליקציה.</li>
          </ul>

          <p className="text-txt"><strong>משותף לשתיהן</strong></p>
          <ul>
