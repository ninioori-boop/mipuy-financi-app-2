...
const NOTES = [
  'כל מטרת המשימות היא שתביאו אלינו את הנתונים. בפגישה ננתח הכול יחד ונבין מה ואיך צריך לעשות — עכשיו חשוב רק לאסוף את כל הנתונים הרלוונטיים.',
  'אם יש שאלה, או שמשהו בתהליך לא ברור או נראה מוזר — זה ממש בסדר, ואנחנו כאן בדיוק בשביל זה. שלחו הודעה בקבוצה המשותפת ונחזור אליכם בהקדם.',
  'חשוב מאוד להעלות את כל הנתונים והמסמכים בדיוק כפי שכתוב במשימות — לשאלות המתאימות בעמוד "העלאת מסמכים".',
]

type Section = { icon: string; title: string; note?: string; steps: string[] }
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="rounded-xl border border-gold/40 bg-gold/5 p-6 space-y-3">
        ...
        <p className="text-sm text-txt leading-relaxed">
          כדי שנעשה את התהליך בצורה הכי טובה ואפקטיבית — וכדי שנוכל לייצר שינוי אמיתי — אנחנו רוצים לדעת הכול.
      ...
      <div className="rounded-xl border border-gold/40 bg-gold/5 p-6 text-center space-y-3">
        ...
        <p className="text-xs text-muted-txt">אנחנו זמינים בוואטסאפ לכל שאלה על המשימות או בכללי 🙂</p>
        <div><CtaButton /></div>
      </div>
    </div>
  )
