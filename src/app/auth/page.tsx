      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <h1 data-brand="nameEn" className="text-2xl font-bold text-[color:var(--wordmark,var(--gold))] drop-shadow-[0_2px_12px_color-mix(in_srgb,var(--gold)_40%,transparent)]">
              <BrandNameEn />
            </h1>
            <p data-brand="tagline" className="text-white/70 text-sm mt-1"><BrandTagline /></p>
          </div>
